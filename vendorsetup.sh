...
if [ "$1" = "$FDEVICE" -o "$FOX_BUILD_DEVICE" = "$FDEVICE" ]; then
    ...
    export TARGET_DEVICE_ALT="rmx2202,lahaina,oplus,ossi" #如果设备有多个代码名，请使用此选项，以便OrangeFox zip安装器可以支持备用代码名，而不会直接失败
    ...
    export FOX_BUGGED_AOSP_ARB_WORKAROUND="1616300800" #使用此选项设置一个旧的UTC时间，以绕过一些ROM中声称的反向升级保护问题
    export FOX_VERSION=a14.0
